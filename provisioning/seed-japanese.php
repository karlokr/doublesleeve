 ...
 *
 *   docker exec -u www-data cryptocards-shop php /provisioning/seed-japanese.php
 */
...
foreach ($seed['singles'] as $card) {
    ...
    foreach ($languages as $language) {
        ...
        $product->description_short[$idLang] = $card['rarity'] !== ''
            ? '<p>' . htmlspecialchars($card['rarity']) . '</p>' : '';
    }
