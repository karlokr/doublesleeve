 ...
 * set by provisioning/currency-sync.php from the Bank of Canada.
 */
...
const FEATURES = [
    ...
    'Print Run' => [
        'fr' => 'Tirage',
        'values' => ['1st Edition', 'Shadowless', 'Unlimited', 'Prerelease', 'Staff'],
    ...
    'Print Region' => [
        'fr' => 'Région d\'impression',
        // Print region is a real price axis - an Asia-English box and a US box of
        // the same set trade at different numbers.
        'values' => ['US / International English', 'Europe English', 'Asia English',
                     'Japan', 'Korea', 'China', 'Latin America'],
    ],
    'Seal Status' => [
        'fr' => 'État du scellage',
...
// provisioning/sets-tcgplayer.php, which builds it from TCGplayer groups - the
