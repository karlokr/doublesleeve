...
/**
 * Short codes for disambiguating a set or era name in a mixed list.
 *
 * Western is deliberately EMPTY. A combined list is read against the region a
 * shopper already knows - "Scarlet & Violet" and "Scarlet & Violet (JP)" - and
 * tagging both sides would just add noise to the one everybody means by default.
 */
const REGION_CODE = [
    'Western' => '',
    'Japanese' => 'JP',
